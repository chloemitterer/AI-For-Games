...
class Agent(object):
    ...
    def __init__(self, world=None, scale=20.0, mass=1.0, mode='hide'):
    ...
    def flee(self, hunter_pos):
        ...
        if self.pos.distanceSq(hunter_pos) < 4000:
    ...
    def hide(self):
        self.besthidingspot = min(self.world.hidingspots, key = lambda h: h.distance(self.pos))

        if self.besthidingspot:
            return self.arrive(self.besthidingspot, 'slow')

        return flee(self.world.hunter)