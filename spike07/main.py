...
from agent import Agent, AGENT_MODES, BEHAVIOUR_WEIGHTS  # Agent with seek, arrive, flee and pursuit
...
def on_key_press(symbol, modifiers):
    ...
    # Toggle debug force line info on the agent
        ...
        BEHAVIOUR_WEIGHTS['cohesion']+=1
    elif symbol == KEY.V:
        BEHAVIOUR_WEIGHTS['cohesion']-=1
    elif symbol == KEY.L:
        BEHAVIOUR_WEIGHTS['alignment']+=1
    elif symbol == KEY.Z:
        BEHAVIOUR_WEIGHTS['alignment']-=1
    elif symbol == KEY.S:
        BEHAVIOUR_WEIGHTS['separation']+=1
    elif symbol == KEY.X:
        BEHAVIOUR_WEIGHTS['separation']-=1
    elif symbol == KEY.W:
        BEHAVIOUR_WEIGHTS['wander']+=1
    elif symbol == KEY.Q:
        BEHAVIOUR_WEIGHTS['wander']-=1
